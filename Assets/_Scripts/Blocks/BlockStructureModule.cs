...
namespace ZE.Purastic {
	...
	{	
		...
		public bool TryAddBlock(BlockProperties blockProperty, FitPosition fitPoint, FitInfo fitInfo, out PlacedBlock placedBlock)
		{
			if (_placedBlocks.TryGetValue(fitPoint.BlockId, out PlacedBlock block))
			{
				placedBlock = _blockList.RegisterBlock(blockProperty, fitPoint.ModelPosition);
