...
namespace ZE.Purastic {
	public enum BlockPreset : byte { Undefined, StandartBrick_1x1,StandartBrick_2x1, StandartBrick_2x2, StandartBrick_2x4}
                ...
                case BlockPreset.StandartBrick_1x1:
                    {
                       ...
                       {
                            new FitPlaneConfig(FitType.Knob, dimensions.y, FaceDirection.Up),
                            new FitPlaneConfig(FitType.Slot, dimensions.y, FaceDirection.Down)
                       };
